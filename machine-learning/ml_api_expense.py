...
# Paths
model_dir = "transaction-classifier-expense/model_artifacts_expense"
model_path = os.path.join(model_dir, "transaction_classifier_model_expense.keras")
tokenizer_path = os.path.join(model_dir, "tokenizer_expense.pkl")
label_encoder_path = os.path.join(model_dir, "label_encoder_expense.pkl")
...
# Initialize FastAPI
app = FastAPI(title="Transaction Classifier Expense API", version="1.0.0")
...
def root():
    return {
        "message": "Welcome to the Transaction Classifier Expense API",
        "version": "1.0.0"
    }
